...
Ext.define('Ext.dirac.views.desktop.Main', {
   ...
   * 
   */
  createWindow : function(loadedObjectType, moduleName, setupData, oResponse) {
  ...
  createNewModuleContainer : function(oData) {
    ...
    me.createWindow(oData.objectType, oData.moduleName, oData.setupData, oData.oResponse);
