...
import EiscatWebDIRAC
from EiscatWebDIRAC.Lib.WebHandler import WebHandler, WebSocketHandler
from EiscatWebDIRAC.Core.CoreHandler import CoreHandler
from EiscatWebDIRAC.Core.StaticHandler import StaticHandler
...
class HandlerMgr( object ):
  ...
  def getPaths( self, dirName ):
    ...
    pathList.append( os.path.join( EiscatWebDIRAC.rootPath, "WebApp", dirName ) )
    return pathList
